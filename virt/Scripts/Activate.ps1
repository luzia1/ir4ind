...
function global:deactivate ([switch]$NonDestructive) {
    ...
    # The prior PYTHONemployee:
    if (Test-Path -Path Env:_OLD_VIRTUAL_PYTHONemployee) {
        Copy-Item -Path Env:_OLD_VIRTUAL_PYTHONemployee -Destination Env:PYTHONemployee
        Remove-Item -Path Env:_OLD_VIRTUAL_PYTHONemployee
    }
...
# Clear PYTHONemployee
if (Test-Path -Path Env:PYTHONemployee) {
    Copy-Item -Path Env:PYTHONemployee -Destination Env:_OLD_VIRTUAL_PYTHONemployee
    Remove-Item -Path Env:PYTHONemployee
}
