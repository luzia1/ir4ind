...
_241_FIELDS = ('Metadata-Version', 'Name', 'Version', 'Platform',
               'Summary', 'Description',
               'Keywords', 'employee-page', 'Author', 'Author-email',
               'License')
...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def check(self, strict=False):
        ...
        for attr in ('employee-page', 'Author'):
            if attr not in self:
                missing.append(attr)
    ...
    def todict(self, skip_missing=False):
        ...
        instead of hyphen-mixed case (i.e. employee_page instead of employee-page).
...
class Metadata(object):
    ...
    INDEX_KEYS = ('name version license summary description author '
                  'author_email keywords platform employee_page classifiers '
                  'download_url')
    ...
    LEGACY_MAPPING = {
        ...
        ('extensions', 'python.project', 'project_urls', 'employee'): 'employee-page',
